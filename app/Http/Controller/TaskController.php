...
class TaskController extends Controller {
	...
	{
		$tasks = $this->taskService->deleteTask();
		return response()->json($tasks);
	}

	public function assignTask()
	{
		$tasks = $this->taskService->assignTask();
		return response()->json($tasks);
	}
	public function unassignTask()
	{
		$tasks = $this->taskService->unassignTask();
		return response()->json($tasks);
	}
	public function addsubTask()
	{
		$tasks = $this->taskService->addsubTask();
		return response()->json($tasks);
	}
	public function deletesubTask()
	{
		$tasks = $this->taskService->deletesubTask();
		return response()->json($tasks);
	}
}